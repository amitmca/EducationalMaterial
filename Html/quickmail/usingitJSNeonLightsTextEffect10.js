...
var neonMessage="***  Welcome To Quick Mail ***";	//Message you want to display with special effect.
var textColor="red"			//The original color of the message.
var neonColorBrighter="magenta";		//The brighter color the special effect will use.
var neonColorDarker="green";			//The darker color the special effect will use.

...
public class ssqlite extends HttpServlet 
{
    public String getServletInfo()
    {
       return "Servlet connects to SQLITE database and displays result of a SELECT";
    }
        ...
        throws IOException, ServletException
    {
        ...
        out.println("<body bgcolor=yellow><H1>CONNECTING TO SQLITE DATABASE...........</H1>");

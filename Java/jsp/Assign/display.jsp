...
<table border="0" width="886" height="143" bgcolor="lightyellow" align="center">
	<tr>
		<td height="78" width="277" valign="middle" align="center">
		<img src="images/logosmall_free.gif" width="258" height="60">
		</td>
		<td height="78" width="358" valign="middle" align="center">
		
		<img border="0" src="images/regitser.bmp" width="358" height="77" align="center" onmouseover="showTip('Please read the tips given for every field and then fill the form',200,25)"  onmouseout="hideTip()" >
		</td>
		<td height="78" width="247" valign="middle" align="center">
		<fieldset>
...
document.write(displaysecond+"/"+displayfirst+"/"+displaythird);
	...
	<tr>
		<td height="59" width="889" valign="top" align="center" colspan="3">
		<fieldset style="background-color:#efffed">
		<table cellpadding="0" cellspacing="0" width="886" height="36">
			<!-- MSTableType="layout" -->
			<tr>
				<td width="186">
		...
		try
			...
			String sql="select * from register order by name asc";

...
<table border="0" width="886" height="170" bgcolor="lightyellow" align="center">
	<tr>
...
document.write(displaysecond+"/"+displayfirst+"/"+displaythird);
	...
	<tr>
		<td height="38" width="880" valign="top" align="center" colspan="3">
		<fieldset style="background-color:#efffed">
...
<%
		...
		try
			...
			String sql="insert into register values('"+name+"','"+pid+"','"+pass+"','"+sec+"','"+ans+"','"+date+"','"+gender+"','"+country+"')";

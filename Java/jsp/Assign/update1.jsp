...
<table border="0" width="886" height="165" bgcolor="lightyellow" align="center">
	<tr>
...
document.write(displaysecond+"/"+displayfirst+"/"+displaythird);
	...
	<tr>
		<td height="21" width="880" valign="top" align="center" colspan="3">
		<fieldset style="background-color:#efffed">
		<FONT face=Verdana color=#0055bb><h1>
		...
		try
			...
			String sql="update register set name='"+name+"',pass='"+pass+"',sec='"+sec+"',ans='"+ans+"',date='"+date+"',gender='"+gender+"',country='"+country+"' where pid='"+pid1+"' ";

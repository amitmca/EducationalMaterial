...
<%
		...
		try
			...
			String sql="update emp set ename='"+ename+"' where eno='"+eno+"'";
...
<h2><center><a href="http://localhost:8080/examples/jsp/Database/new/update.html">Update Another</a></center></h2>

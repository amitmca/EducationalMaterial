	...
	public void actionPerformed(ActionEvent event)
		{
			...
			if(event.getSource()==b1)
				...
				s1="insert into [Sheet1$] values('"+eno+"',"+"'"+ename+"')";
	...
	public void actionPerformed(ActionEvent event)
		{
			...
			if(event.getSource()==b1)
				{
				String eno=t1.getText();
				s1="delete from [Sheet1$] where eno='"+Integer.parseInt(eno)+"'";
				stmt.executeUpdate(s1);
				val="Record Deleted";
				t2.setText(val);
				}
...
public class excel extends Frame implements ActionListener
{

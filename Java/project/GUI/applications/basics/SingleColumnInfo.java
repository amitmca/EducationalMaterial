...
public String getVersion() {return fredysVersion; }
	...
	try {
		...
		v.addElement((String)rs.getString(1));
	        ...
	        v.addElement((Short)new Short(rs.getShort(5)));
	        v.addElement((String)rs.getString(6));
	        v.addElement((Integer)new Integer(rs.getInt(7)));
	        v.addElement((Integer)new Integer(0));
	        v.addElement((Integer)new Integer(rs.getInt(9)));
	        v.addElement((Integer)new Integer(rs.getInt(10)));
	        v.addElement((Integer)new Integer(rs.getInt(11)));
	        v.addElement((String)rs.getString(12));
	        v.addElement((String)rs.getString(13));
	        v.addElement((Integer)new Integer(rs.getInt(14)));
	        v.addElement((Integer)new Integer(rs.getInt(15)));
	        v.addElement((Integer)new Integer(rs.getInt(16)));
	        v.addElement((Integer)new Integer(rs.getInt(17)));

...
public class GenerateForm {
	...
	masterPanel="public JPanel formPanel() {\n"+
                             "   JPanel panel = new JPanel();\n" +
                             "   panel.setLayout(new GridBagLayout());\n" +
                             "   GridBagConstraints gbc = new GridBagConstraints();\n";

	listPanel="public JPanel listPanel() {\n"+
                             "   JPanel panel = new JPanel();\n" +
  ...
  private String toDay() {
	...
	dcls = "\n\n// *** DECLARATIONS ***\n\n" + 
	    "    private "  + firstUpper(getTable()) + "TableModel tableModel;\n\n"  + dcls;
	...
	gpl.fredy.io.FileWriter fw = new gpl.fredy.io.FileWriter(code,formFile);
	...
	**/
	...
	gpl.fredy.io.FileWriter fw2 = new gpl.fredy.io.FileWriter(gm.getTheCode(),tableFile);
  ...
  private String gridBagTreater(Element gbc) {
	...
	listPanel = listPanel + "     theTable = new JTable(tableModel);\n" +
            "     theTable.setPreferredScrollableViewportSize(getMySize());\n" +

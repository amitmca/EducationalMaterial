...
class repstudcourse extends JDialog implements ActionListener,ItemListener
{
	JComboBox cname=new JComboBox();
	JCheckBox male=new JCheckBox("Male");
	JCheckBox female=new JCheckBox("Female");
	JCheckBox all=new JCheckBox("All Courses");
	JButton ok=new JButton("Ok");
	JButton close=new JButton("Close");
	repstudcourse(JFrame parent)
	{
        super(parent,"Course wise Student Report",true);
		
		Container c = getContentPane();
		c.setLayout(null);
	
	    
	    JLabel l=new JLabel("Select Course Name");
       ...
       try
	    ...
	    cname.setBounds(140,40,140,20);
	    all.setBounds(290,40,100,20);
	...
	public void actionPerformed(ActionEvent ae)
	{
	  if(ae.getSource()==ok)
	  {
		   ...
		   try
		   {
		        ...
		        if(cname.isEnabled())
		        {
		          String sqlstr="Select cno from course where cname='"+cname.getSelectedItem().toString()+"'";
				...
				out.write("face=\"Monotype Corsiva\"><strong><u>Course wise Student Information Report</u></strong></font></p>");
				if(all.isSelected()==false)
				{
				  out.write("<p align=\"center\"><font color=\"#0000FF\" size=\"5\"");
				  out.write("face=\"Monotype Corsiva\"><strong><u>Course Name: "+cname.getSelectedItem().toString()+"</u></strong></font></p>");
				}

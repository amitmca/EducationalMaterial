...
class repstudind extends JDialog implements ActionListener
{
	JComboBox studno=new JComboBox();
	JButton ok=new JButton("Ok");
	JButton close=new JButton("Close");
	repstudind(JFrame parent)
	{
        super(parent,"Individual Student Report",true);
	  ...
	  if(ae.getSource()==ok)
	  {
		   ...
		   try
		   {
		        ...
		        Statement stmt = con.createStatement();
 		        ...
 		        String sql="Select * from student where studno="+Integer.parseInt(studno.getSelectedItem().toString());
				...
				out.write("face=\"Monotype Corsiva\"><strong><u> Student Information Report</u></strong></font></p>");
				//for date
				//get current date
				...
				while(rs.next())
				{
					...
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong></font>");
					out.write(rs.getString(5)+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Telephone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong></font><strong>");
					out.write("</strong>"+rs.getInt(6)+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Birhtdate&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong></font>");
					out.write(rs.getInt(7)+"/"+rs.getString(8)+"/"+rs.getInt(9)+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Blood Group&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong></font>");
					out.write(rs.getString(10)+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sex&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong></font>");
					out.write(rs.getString(11)+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Class&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong></font>");
					out.write(rs.getString(12)+"</p>");
					...
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Course&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong></font>");
					out.write(coursename+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hostel No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong></font><strong>");
					out.write("</strong>"+rs.getInt(14)+"</p>");
					out.write("<p><font color=\"#800080\"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Room No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> </font>");
					out.write(rs.getInt(15)+"</p>");
			    }
					out.write("</body></html>");
		    		out.close();
		        	pro = iexp.exec(en);

...
public class AddColumn extends JInternalFrame implements ItemListener,ActionListener 
 {
    JLabel l1;
    JLabel l2;
    JComboBox dbcombo;
    ...
    JTextField size;
    JComboBox colcombo;	
    public static String db="",tables="",table="",col_name="",datatype=""; 	
    ...
    public AddColumn() 
	{
	super("Add a New Column");
	setLocation(275,120);
	ImageIcon i=new ImageIcon("images/grt_value_list.PNG");
 	setFrameIcon(i);
        AddColumnLayout customLayout = new AddColumnLayout();
	...
	if(ae.getSource()==btnalt)
		...
		if(a.equals(""))
			...
			if(datatype.equals("DATE") || datatype.equals("TIME") || datatype.equals("DATETIME"))
			   ...
			   try
			   {	
			   String q="alter table "+db+"."+table+" add "+a+" "+datatype;
			...
			try
			  {
  			  String q="alter table "+db+"."+table+" add "+a+" "+datatype+"("+s+")";
...
class AddColumnLayout implements LayoutManager {

    public AddColumnLayout() {
    }

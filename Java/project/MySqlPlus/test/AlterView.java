...
public class AlterView extends JInternalFrame implements ItemListener,ActionListener 
  {
    JLabel l1;
    JLabel l2;
    JComboBox dbcombo;
	...
	ImageIcon i=new ImageIcon("images/db.View.16x16.PNG");
 	setFrameIcon(i);
        AlterViewLayout customLayout = new AlterViewLayout();
		...
		if(viewname.equals("") || a.equals(""))
			...
			Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
			  ...
			  Statement st=conn.createStatement();
		  	  ...
		  	  String sql="alter view "+db+"."+viewname+" as "+a;
	
			  st.executeUpdate(sql);

			  String str1=viewname+" View Alterted";
...
class AlterViewLayout implements LayoutManager {

    public AlterViewLayout() {
    }

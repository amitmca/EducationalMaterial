...
public class ColumnPriv extends JInternalFrame implements ActionListener,ItemListener
 {
    JLabel label_1;
    JLabel label_2;
    JComboBox usrcombo;
    ...
    JLabel label_9;
    JComboBox colcombo;	
    public static String db="",usr="",table="",colname="",col_name="",with="",select="",insert="",update="",delete="",drop="",create="";	
    public static Login lr;
    public static String u=lr.u;
    public static String p=lr.pass;
    Color c=new Color(238,249,255);
    public static int se=0,in=0,up=0,de=0,dr=0,cr=0,col=0;	

    public ColumnPriv() 
	{
	super("Grant Column Level Privileges");
	setLocation(350,50);
	ImageIcon i=new ImageIcon("images/grt_value_list.png");
 	setFrameIcon(i);
        ColumnPrivLayout customLayout = new ColumnPrivLayout();
	...
	ImageIcon i4=new ImageIcon("images/grt_value_list.png");  
        label_8 = new JLabel(i4);
        getContentPane().add(label_8);

        label_9 = new JLabel("Select Column Name :");
	label_9.setFont(new Font("verdana",Font.BOLD,12));	
...
class ColumnPrivLayout implements LayoutManager {

    public ColumnPrivLayout() {
    }
    ...
    public Dimension preferredLayoutSize(Container parent) {
        ...
        dim.height = 530 + insets.top + insets.bottom;
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+16,insets.top+224,152,24);}
        c = parent.getComponent(7);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+256,72,24);}
        c = parent.getComponent(8);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+296,72,24);}
        c = parent.getComponent(9);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+336,72,24);}
        ...
        if (c.isVisible()) {c.setBounds(insets.left+272,insets.top+336,72,24);}
        c = parent.getComponent(13);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+384,144,24);}
        c = parent.getComponent(14);
        if (c.isVisible()) {c.setBounds(insets.left+24,insets.top+424,136,24);}
        c = parent.getComponent(15);
        if (c.isVisible()) {c.setBounds(insets.left+176,insets.top+424,200,56);}
        c = parent.getComponent(16);
        if (c.isVisible()) {c.setBounds(insets.left+32,insets.top+496,112,24);}
        c = parent.getComponent(17);
        if (c.isVisible()) {c.setBounds(insets.left+224,insets.top+496,120,24);}
        ...
        if (c.isVisible()) {c.setBounds(insets.left+16,insets.top+176,32,32);}
        c = parent.getComponent(22);
        if (c.isVisible()) {c.setBounds(insets.left+48,insets.top+184,152,24);}
        c = parent.getComponent(23);
        if (c.isVisible()) {c.setBounds(insets.left+232,insets.top+184,144,24);}
    }
}

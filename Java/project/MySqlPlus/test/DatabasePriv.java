...
public class DatabasePriv extends JInternalFrame implements ActionListener,ItemListener
 {
    JLabel label_1;
    JLabel label_2;
    JComboBox usrcombo;
    ...
    JButton btngrant;
    JButton btncel;
    public static String db="",usr="",with="",select="",insert="",update="",delete="",drop="",create="";	
    ...
    public DatabasePriv() 
	{
	super("Grant Database Level Privileges");
	setLocation(350,75);
	ImageIcon i=new ImageIcon("images/data_gear.png");
 	setFrameIcon(i);
        DatabasePrivLayout customLayout = new DatabasePrivLayout();
...
public void actionPerformed (ActionEvent ae) 
	...
	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	   ...
	   String sql="grant "+p1+" on "+db+".* to "+usr+"@localhost "+with;
...
class DatabasePrivLayout implements LayoutManager {

    public DatabasePrivLayout() {
    }
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+48,insets.top+24,172,24);}
        ...
        if (c.isVisible()) {c.setBounds(insets.left+16,insets.top+136,152,24);}
        c = parent.getComponent(7);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+176,72,24);}
        c = parent.getComponent(8);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+216,72,24);}
        c = parent.getComponent(9);
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+256,72,24);}
        c = parent.getComponent(10);
        if (c.isVisible()) {c.setBounds(insets.left+272,insets.top+176,72,24);}
        ...
        if (c.isVisible()) {c.setBounds(insets.left+96,insets.top+304,144,24);}
        c = parent.getComponent(14);
        if (c.isVisible()) {c.setBounds(insets.left+24,insets.top+352,136,24);}
        c = parent.getComponent(15);
        if (c.isVisible()) {c.setBounds(insets.left+168,insets.top+344,208,80);}

...
public class DatabasePriv1 extends JInternalFrame implements ActionListener,ItemListener
 {
    JLabel label_1;
    JLabel label_2;
    JComboBox usrcombo;
    ...
    JButton btngrant;
    JButton btncel;
    public static String db="",usr="",select="",insert="",update="",delete="",drop="",create="";	
    ...
    public DatabasePriv1() 
	{
	super("Revoke Database Level Privileges");
	setLocation(350,75);
	ImageIcon i=new ImageIcon("images/data_gear.png");
 	setFrameIcon(i);
        DatabasePriv1Layout customLayout = new DatabasePriv1Layout();
...
public void actionPerformed (ActionEvent ae) 
	...
	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	   ...
	   String sql="revoke "+p1+" on "+db+".* from "+usr+"@localhost ";
...
class DatabasePriv1Layout implements LayoutManager {

    public DatabasePriv1Layout() {
    }
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+16,insets.top+136,172,24);}

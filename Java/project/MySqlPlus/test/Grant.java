...
public class Grant extends JInternalFrame implements ActionListener,ItemListener
   {
    ButtonGroup cbg;
    JRadioButton radglo;
    JRadioButton raddb;
	...
	super("Grant");
	setLocation(350,100);
	ImageIcon i=new ImageIcon("images/checkmark_green.gif");
 	setFrameIcon(i);
        GrantLayout customLayout = new GrantLayout();
...
public void Database()
	{
	DatabasePriv dp=new DatabasePriv();	
	try
	     {
	     Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
...
class GrantLayout implements LayoutManager {

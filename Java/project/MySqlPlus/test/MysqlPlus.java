...

{
	...
	public  JMenuItem newuser,dropuser,edituser,listusers,grant,revoke;

	public  JMenuItem view,index,function,trigger,procedure;

	private JPopupMenu popMenu = new JPopupMenu ();

	private PopupMenu popup=new PopupMenu("Menu");
...
//		Color s=new Color(220,196,170);
		...
		m1=new MenuItem("Create User");
		popup.add(m1);
		popup.addSeparator();
		m1.addActionListener(this);
				
		m2=new MenuItem("Create Database");
		popup.add(m2);
		popup.addSeparator();
		m2.addActionListener(this);

		m3=new MenuItem("Create Table");
		popup.add(m3);
		popup.addSeparator();
		m3.addActionListener(this);

		m4=new MenuItem("Refresh");
		popup.add(m4);
		...
		mnuUsers.setFont(new Font("verdana",Font.BOLD,12));
		mnuUsers.setMnemonic ((int)'U');
		...
		//MenuItems for Users menu
		
		newuser= new JMenuItem ("Create User",new ImageIcon(ClassLoader.getSystemResource("images\\b_usradd.png")));
		newuser.setFont(new Font("verdana",Font.BOLD,12));
		newuser.setForeground(Color.magenta);
		newuser.setBackground(Color.white);
		newuser.setAccelerator (KeyStroke.getKeyStroke(KeyEvent.VK_E, Event.CTRL_MASK));
		newuser.setMnemonic ((int)'E');
		newuser.addActionListener (this);
		
		dropuser= new JMenuItem ("Drop User",new ImageIcon(ClassLoader.getSystemResource("images\\b_usrdrop.png")));
		dropuser.setFont(new Font("verdana",Font.BOLD,12));
		dropuser.setForeground(Color.magenta);
		dropuser.setBackground(Color.white);
		dropuser.setAccelerator (KeyStroke.getKeyStroke(KeyEvent.VK_J, Event.CTRL_MASK));
		dropuser.setMnemonic ((int)'J');
		dropuser.addActionListener (this);

		edituser= new JMenuItem ("Edit User",new ImageIcon(ClassLoader.getSystemResource("images\\b_usredit.png")));
		edituser.setFont(new Font("verdana",Font.BOLD,12));
		edituser.setForeground(Color.magenta);
		edituser.setBackground(Color.white);
		edituser.setAccelerator (KeyStroke.getKeyStroke(KeyEvent.VK_K, Event.CTRL_MASK));
		edituser.setMnemonic ((int)'K');
		edituser.addActionListener (this);
		
		listusers= new JMenuItem ("Show Users",new ImageIcon(ClassLoader.getSystemResource("images\\b_usrlist.png")));
		listusers.setFont(new Font("verdana",Font.BOLD,12));
		listusers.setForeground(Color.magenta);
		listusers.setBackground(Color.white);
		listusers.setAccelerator (KeyStroke.getKeyStroke(KeyEvent.VK_H, Event.CTRL_MASK));
		listusers.setMnemonic ((int)'H');
		listusers.addActionListener (this);

		grant= new JMenuItem ("Grant Priv",new ImageIcon(ClassLoader.getSystemResource("images\\checkmark_green.gif")));
		grant.setFont(new Font("verdana",Font.BOLD,12));
		grant.setForeground(Color.magenta);
		grant.setBackground(Color.white);
		grant.addActionListener (this);

		revoke= new JMenuItem ("Revoke Priv",new ImageIcon(ClassLoader.getSystemResource("images\\checkmark_orange.gif")));
		revoke.setFont(new Font("verdana",Font.BOLD,12));
		revoke.setForeground(Color.magenta);
		revoke.setBackground(Color.white);
	...
	mnuUsers.add(newuser);
	mnuUsers.add(dropuser);
	mnuUsers.add(edituser);
	mnuUsers.add(listusers);
	mnuUsers.add(grant);
	mnuUsers.add(revoke);
	...
	addMouseListener (new MouseAdapter () {
		...
		if(me.getModifiers()!=0)
			{
			popup.show(desktop,me.getX(),me.getY());
			}
		}
	...
	public void actionPerformed (ActionEvent ae) 
		...
		else if (obj == create || obj == btncreate || obj==m3)
			{	
		...
		else if (obj == newuser || obj==m1)
		        {
			AddUser au=new AddUser();
			desktop.add (au);
			au.show ();
			}
		else if (obj == dropuser)
		        {

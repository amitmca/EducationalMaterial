...
public class Select extends JInternalFrame implements ItemListener,ActionListener
  {
    JLabel la;
    JLabel l1;
    JLabel label_2;
	...
	setFrameIcon(i2);
	setLocation(200,30);
        SelectLayout customLayout = new SelectLayout();
...
class SelectLayout implements LayoutManager {

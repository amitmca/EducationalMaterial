...
import java.sql.*;
	...
	public class ShowDatabases extends JInternalFrame implements ActionListener
	{
...
public static String p=l.pass;
		...
		public ShowDatabases ()
			...
			super ("Show Databases", false, true, false, true);
			setSize (375, 375);
			i=new ImageIcon("images/databases.PNG");
			setFrameIcon(i);
			setLocation(250,100);
		...
		if(ae.getSource()==btnShow)
			...
			Connection conn=DriverManager.getConnection(url,"root","");
			 ...
			 ta.setText(text);
  			 ...
  			 String str1="Total Databases:"+count;

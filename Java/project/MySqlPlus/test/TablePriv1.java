...
public class TablePriv1 extends JInternalFrame implements ActionListener,ItemListener
 {
    JLabel label_1;
    JLabel label_2;
    JComboBox usrcombo;
    ...
    public static String db="",usr="",table="",select="",insert="",update="",delete="",drop="",create="";	
    ...
    public TablePriv1() 
	{
	super("Revoke Table Level Privileges");
	setLocation(350,75);
	ImageIcon i=new ImageIcon("images/table.png");
 	setFrameIcon(i);
        TablePriv1Layout customLayout = new TablePriv1Layout();
...
public void actionPerformed (ActionEvent ae) 
	...
	try
	   ...
	   String sql="revoke "+p1+" on "+db+"."+table+" from "+usr+"@localhost ";
...
class TablePriv1Layout implements LayoutManager {

    public TablePriv1Layout() {
    }

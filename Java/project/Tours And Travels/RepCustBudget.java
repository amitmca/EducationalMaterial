...
public class RepCustBudget extends JPanel
{
	...
	public static JFrame frmrepcust;
	public RepCustBudget()
	{
	...
	{
		RepCustBudget repcustobj = new RepCustBudget();
		...
		public void actionPerformed(ActionEvent actEvt)
		{
			if(actEvt.getSource() == butView)
			{
				//Display the Report
				   ...
				   String[] en = {"c:\\program files\\internet explorer\\IEXPLORE.EXE","D:\\Tours And Travels\\Tours And Travels\\CustBudg.html"};
				   try
				   {
				        Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
				        Connection  con = DriverManager.getConnection("jdbc:odbc:Tours",null,null);
				        Statement stmt = con.createStatement();
				        String sql  = "Select Customer.CustNo , CustFirstName,CustLastName,Balance,Occupation, Age,CustAddress,PhNo1,PhNo2,Email,Fax,HealthConstraints from " +
						"Customer , Booking  " +
						...
						" and Booking.PackType='"+ cmbType.getSelectedItem() +"' and Balance >0";

				        ResultSet rs = stmt.executeQuery(sql);

				        File outFile = new File("D:\\Tours And Travels\\Tours And Travels\\CustBudg.html");
				        FileWriter out = new FileWriter(outFile);

				        java.util.Date now = new java.util.Date();
				        out.write("<html><head><title>Budget wise Customer Listing</title></html><body bgcolor=#d3d3d3><h4>");

...
public class AllocateTeacher extends JFrame
{
	public AllocateTeacher()
	{
		setTitle("Allocate Teacher");
		setSize(500,500);				
		setLocation(150,50);
		...
		Container contentPane =getContentPane();
 		...
 		JButton btnAllcTeacher = new JButton("Allocate");
 		btnAllcTeacher.setBounds(220,350,100,30);
 		btnAllcTeacher.setSize(80,30);
 		contentPane.add(btnAllcTeacher);

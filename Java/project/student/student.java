...
if(e.getSource() instanceof Button)
 if("ADD".equals(arg))
  ...
  String sqlStr;
  sqlStr="insert into stu1(NAME,ROLLNO,COLG,SUB1,SUB2,SUB3,SUB4,SUB5)values('"+tf_name.getText()
+"',"+tf_rollno.getText()+",'"+tf_colg.getText()+"',"+tf_sub1.getText()+","+tf_sub2.getText()+","+tf_sub3.getText()+","+tf_sub4.getText()+","+tf_sub5.getText()+")";
  st=con.createStatement();

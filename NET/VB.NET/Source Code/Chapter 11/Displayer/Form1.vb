...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "Call Class1 Display"
        '
        'Button2
        '
        ...
        Me.Button2.Text = "Call Class2 Display"
...
#End Region
    Dim cl As New ClassLibraries.Class1

    Private Sub Button1_Click(ByVal sender As System.Object, _
        ByVal e As System.EventArgs) Handles Button1.Click
        cl.Display("Hello from Visual Basic!")
    End Sub


    Dim c2 As New ClassLibraries.Class2

    Private Sub Button2_Click(ByVal sender As System.Object, _
    ByVal e As System.EventArgs) Handles Button2.Click
        c2.Display("Hello from Visual Basic!")
    End Sub

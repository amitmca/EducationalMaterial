<%@ Page Language="vb" AutoEventWireup="false" Codebehind="WebForm1.aspx.vb" Inherits="Checkboxes2.WebForm1"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:CheckBox id="CheckBox2" style="Z-INDEX: 102; LEFT: 54px; POSITION: absolute; TOP: 200px"
				runat="server" Text="Sesame seeds"></asp:CheckBox>
			...
			<asp:Button id="Button1" style="Z-INDEX: 107; LEFT: 112px; POSITION: absolute; TOP: 336px" runat="server"
				Text="Submit" Height="32px" Width="96px"></asp:Button>
		</form>
	</body>
</HTML>

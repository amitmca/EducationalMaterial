...
Public Class DataSet2
    ...
    Public Class authorsDataTable
        ...
        Public Overloads Function AddauthorsRow(ByVal au_lname As String, ByVal au_fname As String, ByVal phone As String, ByVal au_id As String) As authorsRow
            Dim rowauthorsRow As authorsRow = CType(Me.NewRow,authorsRow)
            rowauthorsRow.ItemArray = New Object() {au_lname, au_fname, phone, au_id}

...
Public Class DataSet1
    ...
    Public Class authorsDataTable
        ...
        Public Overloads Function AddauthorsRow(ByVal au_id As String, ByVal au_lname As String, ByVal au_fname As String, ByVal address As String, ByVal city As String, ByVal phone As String, ByVal state As String, ByVal zip As String, ByVal contract As Boolean) As authorsRow
            Dim rowauthorsRow As authorsRow = CType(Me.NewRow,authorsRow)
            rowauthorsRow.ItemArray = New Object() {au_id, au_lname, au_fname, address, city, phone, state, zip, contract}

...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DataSet11 As DataViews.DataSet1
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataSet11 = New DataViews.DataSet1
        ...
        Me.SqlDataAdapter1.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "authors", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("au_id", "au_id"), New System.Data.Common.DataColumnMapping("au_lname", "au_lname"), New System.Data.Common.DataColumnMapping("au_fname", "au_fname"), New System.Data.Common.DataColumnMapping("address", "address"), New System.Data.Common.DataColumnMapping("city", "city"), New System.Data.Common.DataColumnMapping("phone", "phone"), New System.Data.Common.DataColumnMapping("state", "state"), New System.Data.Common.DataColumnMapping("zip", "zip"), New System.Data.Common.DataColumnMapping("contract", "contract")})})
        ...
        'SqlInsertCommand1
        '
        Me.SqlInsertCommand1.CommandText = "INSERT INTO authors(au_id, au_lname, au_fname, address, city, phone, state, zip, " & _
        "contract) VALUES (@au_id, @au_lname, @au_fname, @address, @city, @phone, @state," & _
        " @zip, @contract); SELECT au_id, au_lname, au_fname, address, city, phone, state" & _
        ...
        'SqlSelectCommand1
        '
        Me.SqlSelectCommand1.CommandText = "SELECT au_id, au_lname, au_fname, address, city, phone, state, zip, contract FROM" & _
        " authors"
        Me.SqlSelectCommand1.Connection = Me.SqlConnection1
        '
        'SqlUpdateCommand1
        '
        Me.SqlUpdateCommand1.CommandText = "UPDATE authors SET au_id = @au_id, au_lname = @au_lname, au_fname = @au_fname, ad" & _
        "dress = @address, city = @city, phone = @phone, state = @state, zip = @zip, cont" & _
        ...
        "L); SELECT au_id, au_lname, au_fname, address, city, phone, state, zip, contract" & _
        ...
        'DataView1
        '
        Me.DataView1.RowFilter = "au_lname='white'"
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(292, 262)

...
Public Class DataSet1
    ...
    Public Class publishersDataTable
        ...
        Public Overloads Function AddpublishersRow(ByVal pub_id As String, ByVal pub_name As String, ByVal city As String, ByVal state As String) As publishersRow
            Dim rowpublishersRow As publishersRow = CType(Me.NewRow,publishersRow)
            rowpublishersRow.ItemArray = New Object() {pub_id, pub_name, city, state}

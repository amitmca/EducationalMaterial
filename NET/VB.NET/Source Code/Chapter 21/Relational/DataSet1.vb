...
Public Class DataSet1
    ...
    Public Class authorsDataTable
        ...
        Public Overloads Function AddauthorsRow(ByVal au_id As String, ByVal au_lname As String, ByVal au_fname As String, ByVal phone As String, ByVal Expr1 As String, ByVal title_id As String, ByVal au_ord As Byte, ByVal royaltyper As Integer) As authorsRow
            Dim rowauthorsRow As authorsRow = CType(Me.NewRow,authorsRow)
            rowauthorsRow.ItemArray = New Object() {au_id, au_lname, au_fname, phone, Expr1, title_id, au_ord, royaltyper}
            Me.Rows.Add(rowauthorsRow)
            Return rowauthorsRow
        End Function
        
        Public Function FindByau_idExpr1title_id(ByVal au_id As String, ByVal Expr1 As String, ByVal title_id As String) As authorsRow
            Return CType(Me.Rows.Find(New Object() {au_id, Expr1, title_id}),authorsRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("Constraint1", New DataColumn() {Me.columnau_id, Me.columnExpr1, Me.columntitle_id}, true))
    ...
    Public Class authorsRow
        ...
        Public Property Expr1 As String
            Get
                Return CType(Me(Me.tableauthors.Expr1Column),String)
            End Get
            Set
                Me(Me.tableauthors.Expr1Column) = value
            End Set
        End Property
        
        Public Property title_id As String
            Get
                Return CType(Me(Me.tableauthors.title_idColumn),String)
            End Get
            Set
                Me(Me.tableauthors.title_idColumn) = value
            End Set
        End Property
        ...
        Public Property au_ord As Byte
            Get
                Try 
                    Return CType(Me(Me.tableauthors.au_ordColumn),Byte)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableauthors.au_ordColumn) = value
            End Set
        End Property
        ...
        Public Property royaltyper As Integer
            Get
                Try 
                    Return CType(Me(Me.tableauthors.royaltyperColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableauthors.royaltyperColumn) = value
            End Set
        End Property
        
        Public Function Isau_ordNull() As Boolean
            Return Me.IsNull(Me.tableauthors.au_ordColumn)
        End Function
        
        Public Sub Setau_ordNull()
            Me(Me.tableauthors.au_ordColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsroyaltyperNull() As Boolean
            Return Me.IsNull(Me.tableauthors.royaltyperColumn)
        End Function
        
        Public Sub SetroyaltyperNull()
            Me(Me.tableauthors.royaltyperColumn) = System.Convert.DBNull
        End Sub
    End Class

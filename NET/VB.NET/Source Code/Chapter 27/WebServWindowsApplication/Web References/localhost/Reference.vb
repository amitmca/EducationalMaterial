...
Namespace localhost
    ...
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Service1Soap", [Namespace]:="http://tempuri.org/MyWebService/Service1")>  _
    Public Class Service1
        ...
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/MyWebService/Service1/GetAuthors", RequestNamespace:="http://tempuri.org/MyWebService/Service1", ResponseNamespace:="http://tempuri.org/MyWebService/Service1", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        ...
        '<remarks/>
        Public Function EndGetAuthors(ByVal asyncResult As System.IAsyncResult) As DataSet1
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),DataSet1)
        End Function
        
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/MyWebService/Service1/UpdateAuthors", RequestNamespace:="http://tempuri.org/MyWebService/Service1", ResponseNamespace:="http://tempuri.org/MyWebService/Service1", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function UpdateAuthors(ByVal Changes As DataSet1) As DataSet1
            Dim results() As Object = Me.Invoke("UpdateAuthors", New Object() {Changes})
            Return CType(results(0),DataSet1)
        End Function
        
        '<remarks/>
        Public Function BeginUpdateAuthors(ByVal Changes As DataSet1, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("UpdateAuthors", New Object() {Changes}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndUpdateAuthors(ByVal asyncResult As System.IAsyncResult) As DataSet1
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),DataSet1)
        End Function
    End Class
    ...
    Public Class DataSet1
        ...
        Public Class authorsDataTable
            ...
            Public Overloads Function AddauthorsRow(ByVal au_id As String, ByVal au_lname As String, ByVal au_fname As String, ByVal phone As String, ByVal address As String, ByVal state As String, ByVal city As String, ByVal zip As String, ByVal contract As Boolean) As authorsRow
                Dim rowauthorsRow As authorsRow = CType(Me.NewRow,authorsRow)
                rowauthorsRow.ItemArray = New Object() {au_id, au_lname, au_fname, phone, address, state, city, zip, contract}

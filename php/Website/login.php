...
<body bgcolor="yellow">
<form action="login1.php" method="POST" name="frmLogin">
...
<table>
   <tr>
	...
	<td bordercolor="#DEEFF9">
		...
		<td>
<input name="txtusr" type="text" tabindex=2 value="<?php echo $_POST['txtusr']?>" size="35" maxlength="35">
		</td>
	     </tr>
	     <tr bordercolor"#E6F3FB"> 
 		<td align="right"><b><img src="password.png" width="35" height="35" border="0"><font color="magenta">Password:</font></td>
		<td>
<input name="txtpass" type="password" tabindex=1 value="<?php echo $_POST['txtpass']?>" size="35" maxlength="15">
		</td>
	     </tr>
